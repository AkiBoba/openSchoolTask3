...
@Aspect
@Component
public class OrderAdviceAspect {

    private static final Logger log = LogManager.getLogger();

    @Before("com.example.openschooltask3.aspect.LoggingAspect.isOrderServiceLayer() && com.example.openschooltask3.aspect.LoggingAspect.isSomeMethod()")
    ...
    @AfterReturning(value = "com.example.openschooltask3.aspect.LoggingAspect.isOrderServiceLayer() && com.example.openschooltask3.aspect.LoggingAspect.isSomeMethod()", returning = "result")
